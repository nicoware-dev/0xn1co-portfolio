...
import 'kleur/colors';
import { c as $$SocialIcons, $ as $$Header, m as mainMenu, a as $$Footer, b as $$Layout } from '../chunks/Footer_Bz4AiNVI.mjs';
import { $ as $$Title } from '../chunks/Title_C5xcF7xu.mjs';
import { $ as $$Boton } from '../chunks/Boton_C-6W3hM5.mjs';
/* empty css                                 */
import { g as getCollection, $ as $$FormattedDate } from '../chunks/_astro_content_DtdrwtPd.mjs';
import 'clsx';
import { s as services, $ as $$CallToAction } from '../chunks/servicesData_B1ZMaLc6.mjs';
import { c as categoryTitles, a as categoryIcons } from '../chunks/portfolioData_CAegd_FN.mjs';
export { renderers } from '../renderers.mjs';

const $$About = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section id="about" class="about"> <div class="about__container"> <div class="about__content"> ${renderComponent($$result, "Title", $$Title, { "margin": "1rem", "contenido": "About Me" })} <p class="about__text">
I’m Nicolas, a software engineer and automation consultant focused on building systems that actually work in real operations.
<br><br>
Over the last decade, I’ve worked across engineering, automation, and complex technical environments, helping teams turn messy workflows into clear, reliable systems.
<br><br>
My work today sits at the intersection of software engineering, AI automation, and operational design. I help small teams and tech-enabled businesses reduce manual effort, improve consistency, and scale without introducing unnecessary complexity.
<br><br>
I’m not interested in hype or “AI for the sake of AI.” My focus is on practical automation — the kind that teams trust, maintain, and rely on every day.
<br><br>
If your operation feels heavier than it should, or if automation efforts haven’t delivered the clarity you expected, that’s usually where I can help.
</p> <div class="social-icons-container"> ${renderComponent($$result, "SocialIcons", $$SocialIcons, { "width": "25", "height": "25" })} </div> <div class="button-wrapper"> ${renderComponent($$result, "Boton", $$Boton, { "href": "/contact", "texto": "Let\u2019s talk about what\u2019s not working", "class": "primary" })} </div> </div> </div> </section>`;
...
const $$Hero = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="hero" data-astro-cid-ar5v7lgx> <div class="hero__container" data-astro-cid-ar5v7lgx> <div class="text__content stagger-children" data-astro-cid-ar5v7lgx> <div class="title-wrapper" data-astro-cid-ar5v7lgx> <span class="pre-title animate fade-in-down" data-astro-cid-ar5v7lgx>AI Automation & Agentic Systems Engineer</span> <h1 class="hero__title color__gradiente animate fade-in" data-astro-cid-ar5v7lgx>
I help small teams and tech-enabled businesses reduce manual work and operational friction through practical AI automation and custom systems.
</h1> </div> <p class="hero__text animate fade-in-up animate-delay-200" data-astro-cid-ar5v7lgx>
Clear, reliable automation that removes chaos instead of adding complexity.
</p> <div class="roles animate fade-in-up animate-delay-300" data-astro-cid-ar5v7lgx> <span data-astro-cid-ar5v7lgx>AI Automation Engineer</span> <span class="separator" data-astro-cid-ar5v7lgx>•</span> <span data-astro-cid-ar5v7lgx>Multi-Agent Architect</span> <span class="separator" data-astro-cid-ar5v7lgx>•</span> <span data-astro-cid-ar5v7lgx>n8n Specialist</span> <span class="separator" data-astro-cid-ar5v7lgx>•</span> <span data-astro-cid-ar5v7lgx>Full‑stack Developer</span> </div> <div class="button-group animate fade-in-up animate-delay-400" data-astro-cid-ar5v7lgx> ${renderComponent($$result, "Boton", $$Boton, { "href": "/contact", "texto": "Let\u2019s talk about your challenge", "class": "primary", "data-astro-cid-ar5v7lgx": true })} ${renderComponent($$result, "Boton", $$Boton, { "href": "/case-studies", "texto": "See Case Studies", "class": "secondary", "data-astro-cid-ar5v7lgx": true })} </div> </div> <div class="image-wrapper animate scale-in animate-delay-200" data-astro-cid-ar5v7lgx> ${renderComponent($$result, "ProfileImage", $$ProfileImage, { "size": "xl", "className": "hero__img", "data-astro-cid-ar5v7lgx": true })} <div class="glow-effect" data-astro-cid-ar5v7lgx></div> </div> </div> </section> `;
...
const $$ServicesOverview = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="services-overview py-20" data-astro-cid-ijt4t2wa> <div class="max-w-[var(--max-width)] mx-auto px-4" data-astro-cid-ijt4t2wa> <div class="text-center mb-16" data-astro-cid-ijt4t2wa> ${renderComponent($$result, "Title", $$Title, { "contenido": "Services", "data-astro-cid-ijt4t2wa": true })} <p class="section-subtitle" data-astro-cid-ijt4t2wa>Operational Clarity & Scalable Systems</p> </div> <div class="grid md:grid-cols-3 gap-8" data-astro-cid-ijt4t2wa> ${services.map((service) => renderTemplate`<a${addAttribute(`/services/${service.slug}`, "href")} class="service-card" data-astro-cid-ijt4t2wa> <div class="service-icon" data-astro-cid-ijt4t2wa> ${renderComponent($$result, "iconify-icon", "iconify-icon", { "icon": service.icon, "width": "48", "height": "48", "data-astro-cid-ijt4t2wa": true })} </div> <div class="service-content" data-astro-cid-ijt4t2wa> <h3 class="service-title" data-astro-cid-ijt4t2wa>${service.title}</h3> <p class="service-description" data-astro-cid-ijt4t2wa>${service.description}</p> <ul class="service-features" data-astro-cid-ijt4t2wa> ${service.features.map((feature) => renderTemplate`<li data-astro-cid-ijt4t2wa>${feature}</li>`)} </ul> <div class="learn-more" data-astro-cid-ijt4t2wa> <span data-astro-cid-ijt4t2wa>Learn More</span> ${renderComponent($$result, "iconify-icon", "iconify-icon", { "icon": "mdi:arrow-right", "width": "20", "height": "20", "data-astro-cid-ijt4t2wa": true })} </div> </div> </a>`)} </div> </div> </section> `;
}, "C:/Users/PC/Documents/GitHub/0xn1co-portfolio/src/components/ServicesOverview.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Nicolas Dominici | AI Automation & Systems Consultant", "description": "I help small teams and tech-enabled businesses reduce manual work and operational friction through practical AI automation and custom systems.", "image": "/og-image.png", "type": "website", "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="app-container" data-astro-cid-j7pv25f6> ${renderComponent($$result2, "Header", $$Header, { "origin": mainMenu, "data-astro-cid-j7pv25f6": true })} <main data-astro-cid-j7pv25f6> ${renderComponent($$result2, "Hero", $$Hero, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "About", $$About, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "Skills", $$Skills, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "ServicesOverview", $$ServicesOverview, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "ProjectsOverview", $$ProjectsOverview, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "CallToAction", $$CallToAction, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "BlogHome", $$BlogHome, { "data-astro-cid-j7pv25f6": true })} </main> ${renderComponent($$result2, "Footer", $$Footer, { "data-astro-cid-j7pv25f6": true })} </div> ` })} `;
